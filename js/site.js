...
(function () {
  ...
  var projects = [
    { name: "Tommy's Express POS", description: "Led the POS platform running across 250+ car wash locations, integrating payments, license plate recognition, and high-volume daily operations.", tags: ["Swift", "SwiftUI", "Stripe"], role: "Mobile Development Manager" },
    { name: "Tommy Express App", description: "Led the consumer mobile platform used by more than 2 million customers across iOS and Android.", tags: ["React Native"], role: "Mobile Development Manager" },
    { name: "TCW FLEX POS", description: "Built and launched a new internal product that supported site rollouts and day-to-day belt management operations.", tags: ["Swift", "SwiftUI", "SPM"], role: "Senior iOS Engineer" },
    ...
    { name: "Corporate Phone", description: "Took a production iOS app from greenfield development through launch with TDD, CI/CD, and release automation.", tags: ["Swift", "SPM", "CircleCI"], role: "iOS Engineer" },
